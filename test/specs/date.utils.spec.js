...
describe('date.utils', () => {
  ...
  describe('#convertDateToUTC', () => {
    it('should work', () => {
      ...
      expect(utc.getFullYear()).to.equal(2020)
      expect(utc.getMonth()).to.equal(0)
      expect(utc.getDate()).to.equal(1)
      expect(utc.getHours()).to.equal(8)
      expect(utc.getMinutes()).to.equal(1)
      expect(utc.getSeconds()).to.equal(2)
    })
  })
