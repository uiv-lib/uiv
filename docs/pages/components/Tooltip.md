...
## [Tooltip.js](https://github.com/wxsms/uiv/blob/release/src/components/tooltip/Tooltip.js)
...
This is the directive for Tooltip. The binding value will be the text content of corresponding tooltip.
